...
app = Flask(__name__)
CORS(app, origins=[
    "https://meek-ganache-28c472.netlify.app",  # Your frontend domain
...
WEBHOOK_URL = os.getenv("WEBHOOK_URL", "socialmediaboostorder-production.up.railway.app/verify_callback")
